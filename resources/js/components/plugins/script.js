export function Script(){
	...
	// Initialiser le carousel partenaires si OwlCarousel et jQuery sont disponibles
    if (window && window.$ && $('.sponsors-carousel, .partners-carousel').length) {
      $('.sponsors-carousel, .partners-carousel').owlCarousel({
        loop: true,
        margin: 30,
        nav: false,
        smartSpeed: 500,
...
export function header(){
   ...
   ========================================================================== */
    ...
    // 🔥 SUPPRIME l'ancien listener
	$(window).off('scroll.headerStyle');

	// 🔥 AJOUTE le listener AVEC namespace
	$(window).on('scroll.headerStyle', function () {
		headerStyle();
	});
